...
for i=1:length(allOut)
    ...
    fields = ["subjectID", "Date", "Timer", "Trials", "NoInitiations", "CorrectResponses",...
    ...
    values = {allOut{i}.Subject, allOut{i}.StartDate, allOut{i}.T, allOut{i}.I, allOut{i}.N, allOut{i}.G.', ...
...
save('DREADDsACCCohort3DCZSessions.mat', "data_dictionary");
